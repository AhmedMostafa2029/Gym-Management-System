...
namespace GymSystem.BLL.Services.Classes
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<Result> CancelBookingAsync(int memberId, int sessionId, CancellationToken ct = default)
        {
            ...
            _unitOfWork.BookingRepository.Delete(booking.Id);
        ...
        {
            var booking = await _unitOfWork.BookingRepository.FirstOrDefaultAsync(b => b.MemberId == memberId && b.SessionId == sessionId, ct: ct);
            if (booking is null) return Result.NotFound("Booking not found.");
        ...
        public async Task<IEnumerable<SessionViewModel>> GetAllSessionsAsync(CancellationToken ct = default)
        {
            ...
            var bookings = await _unitOfWork.SessionRepository.GetAllSessionsWithTrainerAndCatogryAsync(ct);
